...
#### 안정버전
**Nightly 버전을 사용하는 것을 추천합니다.** 안정 버전을 위한 추천하지 않는 방법입니다.
1. `about:debugging#/runtime/this-firefox`으로 갑니다.
2. "임시 부가 기능 로드..."를 누르고 다운로드한 zip 파일을 선택합니다.

**이 방법으로 파이어폭스에 설치할 경우, 브라우저가 닫히고 나서 삭제될 것입니다.**

### 사파리
지원안함

## 업데이트
확장 프로그램을 삭제 후 재설치 하세요. 가장 확실하게 업데이트 하는 방법입니다.
이 확장프로그램은 로컬에 중요한 설정을 저장하지 않습니다.
...
## FAQ
#### 경고가 뜹니다; Manifest version 2 is deprecated, and support will be removed in 2023.
무시하세요
